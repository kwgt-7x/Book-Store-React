...
export interface ApiAutherAuther extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    class_icon_1: Schema.Attribute.String;
    class_icon_2: Schema.Attribute.String;
    class_icon_3: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    auther: Schema.Attribute.String;
    categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::category.category'
    >;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authers: Schema.Attribute.Relation<'manyToMany', 'api::auther.auther'>;
...
export interface ApiSliderSlider extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    btn_1: Schema.Attribute.String;
    btn_2: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    img_hero: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::slider.slider'
